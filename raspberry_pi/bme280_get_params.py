...
## Referenced from https://github.com/SWITCHSCIENCE/samplecodes
...
class bme280Reader:
    ...
    def readData(self):
        ...
        comp_temperature=self.compensate_T(temp_raw)
        comp_pressure=self.compensate_P(pres_raw)
        comp_humidity=self.compensate_H(hum_raw)
        return {"temp_degCel": comp_temperature, "pressure_hPa": comp_pressure, "hum_percent": comp_humidity}
    ...
    def compensate_P(self, adc_P):
        ...
        comp_pressure='{:.2f}'.format(pressure/100)
    ...
    def compensate_T(self, adc_T):
        ...
        comp_temperature='{:.2f}'.format(temperature)
